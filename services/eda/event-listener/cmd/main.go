...
import (
	...
	"go-knowledge/services/eda/event-listener/internal/server"
	"log"
...
func main() {
	...
	listener := server.NewServer(rmq, notifier)
	listener.RegisterConsumer(consumerName, exchangeName, queueName, routingKey)
    listener.Start()
}
